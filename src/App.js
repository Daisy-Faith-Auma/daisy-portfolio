...
import { Github, Linkedin, Mail, ExternalLink, ChevronDown, Code, Database, Globe, ArrowRight, FileText, Users, Brain, Award, Youtube, BookOpen } from 'lucide-react';
...
const App = () => {
  ...
  const skills = [
    ...
    { 
      ...
      description: 'YouTube AI explainers. Technical articles on Medium, Substack & Dev.to. 8 Twitter Spaces, 600+ listeners.'
    },
    { 
  ...
  const projects = [
    {
      ...
      github: 'https://github.com/archetypeai',
      live: 'https://www.archetypeai.io/'
    },
    {
    ...
    },
    {
      ...
      github: 'https://www.xlsoft.com/doc/kudan/',
  ...
  const contentLinks = [
    ...
    {
      platform: 'Lux Academy X',
      handle: '@LuxDevHQ',
      description: 'Developer community updates',
      url: 'https://x.com/LuxDevHQ',
    ...
    {
      platform: 'Lux Academy',
      handle: 'Website',
      description: 'Developer learning platform',
      url: 'https://www.luxdevhq.ai/',
  ...
  const ProjectCard = ({ project }) => (
    <div className="group relative bg-gray-800/50 backdrop-blur-sm rounded-2xl overflow-hidden border border-gray-700/50 hover:border-gray-500/50 transition-all duration-500 transform hover:-translate-y-2 hover:shadow-2xl hover:shadow-gray-500/20">
      ...
      <div className="p-6">
        ...
        <div className="flex flex-wrap gap-2">
          {project.tech.map((tech, i) => (
            <span key={i} className="px-3 py-1 bg-gray-500/20 text-gray-300 rounded-full text-sm font-medium border border-gray-500/30">
              {tech}
            </span>
          ))}
        </div>
    ...
    <div className="min-h-screen bg-gray-900 text-white overflow-hidden">
      ...
      <section id="home" className="min-h-screen flex items-center justify-center relative pt-20">
        <div className="max-w-7xl mx-auto px-6 text-center relative z-10">
          ...
          <p className="text-xl md:text-2xl text-gray-300 mb-4">Technical Writer • Developer Relations Engineer • Data Science and AI Enthusiast</p>
          <p className="text-lg text-gray-400 mb-8 max-w-3xl mx-auto leading-relaxed">
            ...
            <span className="text-blue-400 font-semibold"> Lux Tech Academy</span>. 
            Google Community Builder & Women Techmakers Ambassador.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
            <a 
              href="https://github.com/Daisy-Faith-Auma"
              target="_blank" 
              rel="noopener noreferrer"
              className="px-8 py-4 bg-gradient-to-r from-gray-700 to-gray-900 rounded-full font-semibold hover:shadow-lg hover:shadow-gray-500/25 transform hover:scale-105 transition-all duration-300 flex items-center space-x-2 hover:from-gray-600 hover:to-gray-800"
            >
          ...
          <div className="flex justify-center space-x-6">
            <a href="https://github.com/Daisy-Faith-Auma" target="_blank" rel="noopener noreferrer" className="p-3 bg-gray-800/50 backdrop-blur-sm rounded-full hover:bg-purple-600 transition-all duration-300 transform hover:scale-110 hover:shadow-lg">
            ...
            <a href="https://x.com/daisyfaithauma" target="_blank" rel="noopener noreferrer" className="p-3 bg-gray-800/50 backdrop-blur-sm rounded-full hover:bg-blue-400 transition-all duration-300 transform hover:scale-110 hover:shadow-lg">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
              </svg>
            </a>
            <a href="mailto:daisyfaithauma@gmail.com" className="p-3 bg-gray-800/50 backdrop-blur-sm rounded-full hover:bg-gray-600/20 transition-all duration-300 transform hover:scale-110 hover:shadow-lg">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            {achievements.map((achievement, index) => (
              <div key={index} className="p-6 bg-gray-800/30 backdrop-blur-sm rounded-2xl border border-gray-700/50 text-center transform hover:scale-105 transition-all duration-300">
                <div className="w-12 h-12 mx-auto mb-4 bg-gradient-to-r from-gray-600 to-gray-800 rounded-full flex items-center justify-center">
                  <Award className="w-6 h-6 text-white" />
                </div>
                <h3 className="text-lg font-bold mb-2">{achievement.title}</h3>
                <p className="text-gray-300 text-sm font-medium mb-2">{achievement.organization}</p>
  ...
  <h4 className="font-bold mb-2 text-white">Programming</h4>
...
<div className="p-6 bg-gray-800/30 backdrop-blur-sm rounded-2xl border border-gray-700/50">
  ...
  <h4 className="font-bold mb-2 text-white">Frameworks & Tools</h4>
...
<div className="p-6 bg-gray-800/30 backdrop-blur-sm rounded-2xl border border-gray-700/50">
  ...
  <h4 className="font-bold mb-2 text-white">Documentation</h4>
...
<div className="p-6 bg-gray-800/30 backdrop-blur-sm rounded-2xl border border-gray-700/50">
  ...
  <h4 className="font-bold mb-2 text-white">Certifications</h4>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-6 mb-12">
            {contentLinks.map((link, index) => (
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="group p-8 bg-gray-800/30 backdrop-blur-sm rounded-2xl border border-gray-700/50 hover:border-gray-500/50 transition-all duration-300 transform hover:scale-105 text-center"
              >
                <div className={`w-16 h-16 mx-auto mb-4 bg-gray-700/50 rounded-full flex items-center justify-center group-hover:bg-gray-600/20 transition-colors ${link.color}`}>
                  {link.icon}
                </div>
    ...
    <div className="p-6 bg-gray-800/30 backdrop-blur-sm rounded-2xl border border-gray-700/50 text-center transform hover:scale-105 transition-all duration-300">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="p-8 bg-gray-800/30 backdrop-blur-sm rounded-3xl border border-gray-700/50 mb-8">
            <div className="grid md:grid-cols-3 gap-6 mb-8">
              <a href="https://www.linkedin.com/in/daisyfaithauma/" target="_blank" rel="noopener noreferrer" className="p-6 bg-gray-700/30 rounded-2xl hover:bg-gray-600/20 transition-all duration-300 transform hover:scale-105 group">
              ...
              <a href="https://x.com/daisyfaithauma" target="_blank" rel="noopener noreferrer" className="p-6 bg-gray-700/30 rounded-2xl hover:bg-gray-600/20 transition-all duration-300 transform hover:scale-105 group">
              ...
              <a href="https://github.com/Daisy-Faith-Auma" target="_blank" rel="noopener noreferrer" className="p-6 bg-gray-700/30 rounded-2xl hover:bg-gray-600/20 transition-all duration-300 transform hover:scale-105 group">
            ...
            <form 
              ...
              className="p-6 bg-gray-700/30 rounded-2xl border border-gray-600/50 max-w-2xl mx-auto"
            >
              ...
              <div className="flex items-center justify-center mb-6">
                ...
                <h3 className="font-semibold text-xl text-white">Send Message</h3>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                <div>
                  ...
                  <input 
                    ...
                    id="name" 
                    required
                    className="w-full px-3 py-2 bg-gray-800/50 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:border-gray-400 focus:outline-none transition-colors"
              ...
              <div className="mb-6">
                ...
                <textarea 
                  ...
                  rows="4" 
                  required
                  className="w-full px-3 py-2 bg-gray-800/50 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:border-gray-400 focus:outline-none transition-colors resize-vertical"
              ...
              <button 
                type="submit"
                className="w-full px-6 py-3 bg-gradient-to-r from-gray-700 to-gray-900 text-white rounded-lg font-semibold hover:from-gray-600 hover:to-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-500 transition-all duration-300 transform hover:scale-105"
              >
                Send Message
              </button>
            </form>
          ...
          <div className="text-center">
            ...
            <div className="flex justify-center space-x-4">
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="px-6 py-3 bg-gradient-to-r from-gray-700 to-gray-900 rounded-full font-semibold hover:shadow-lg hover:shadow-gray-500/25 transform hover:scale-105 transition-all duration-300 hover:from-gray-600 hover:to-gray-800"
              >
                Lux Tech Academy
              </a>
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="px-6 py-3 border border-gray-600 rounded-full font-semibold hover:border-gray-500 hover:text-gray-300 transition-all duration-300"
              >
                @LuxTechAcademy
              </a>
            </div>
      ...
      <footer className="py-8 border-t border-gray-800/50 bg-gray-900/50 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-6 text-center">
          <p className="text-gray-500 text-sm">&copy; {new Date().getFullYear()} Daisy Faith Auma. All rights reserved.</p>
